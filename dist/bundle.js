...
function drawDog(p,t){
  ...
  if(breed==='corgi') _drawCorgi(x,by,t,C,D,L,W,K,p);
...
function _drawHusky(x,by,t,C,D,L,W,K,p){
  ...
  px(x+9,by+2+tw*0.5,5,12,D); px(x+11,by+tw,4,8,C); px(x+12,by-2+tw,3,6,W);
...
function _drawShiba(x,by,t,C,D,L,W,K,p){
  ...
  px(x+8,by-1,5,8,D); px(x+10,by-5+tw,4,6,C); px(x+9,by-8+tw,5,4,C); px(x+7,by-7+tw,4,3,C);
  if(p.dir==='down'||p.dir==='up'){
    const facing=p.dir==='down';
...
function _drawCorgi(x,by,t,C,D,L,W,K,p){
  ...
  px(x+9,by+1+tw,6,8,W); px(x+10,by-1+tw,5,6,L);
  if(p.dir==='down'||p.dir==='up'){
    const facing=p.dir==='down';
...
function _drawPoodle(x,by,t,C,D,L,W,K,p){
  ...
  arc(x+10,by-1+tw*0.5,3,D);arc(x+12,by-3+tw,4,C);
...
function _drawDalmatian(x,by,t,C,D,L,W,K,p){
  ...
  px(x-7,by+19+la,5,3,'#9A7060');px(x+2,by+19+la2,5,3,'#9A7060');
  const tw=Math.sin(t/160)*5;
  px(x+9,by+2+tw*0.5,5,12,BSH);px(x+11,by+tw,4,8,BASE);px(x+12,by-2+tw,3,6,W);
  if(p.dir==='down'||p.dir==='up'){
    const facing=p.dir==='down';
